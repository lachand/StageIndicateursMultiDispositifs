...
class Gauge(Widget):
    ...
    def __init__(self, **kwargs):
        ...
        self._gauge.rotation = kwargs["angle"]
        ...
        self._needle.rotation = kwargs["angle"]
    ...
    def _turn(self, *args):
        ...
        self._needle.rotation = (50 * self.unit) - (self.value * self.unit) + self.angle
...
class GaugeApp(App):
    def build(self):
        ...
        mygauge = Gauge(value=50, size_gauge=256, size_text=25, angle=90)
